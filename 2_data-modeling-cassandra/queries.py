...
insert_song_history = """INSERT INTO song_history (song_title, first_name, last_name, user_id)
                         VALUES (%s, %s, %s, %s)"""
...
select_song_data = "SELECT first_name, last_name FROM song_history WHERE song_title=%s"
